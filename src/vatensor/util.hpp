...
namespace va::util {
	inline std::size_t normalize_axis(const std::ptrdiff_t axis, const std::size_t dimension) {
	...
	inline std::size_t normalize_index(const std::ptrdiff_t index, const std::size_t size) {
