...
- ``nd.arange`` with very large integer ``start`` / ``stop`` and a float ``step`` returned the wrong number of elements (e.g. ``nd.arange(-2305843009213692800, -2305843009213694530, -91.0)`` returned 17 instead of 20).
