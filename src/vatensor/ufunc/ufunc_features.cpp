...
namespace va::ufunc::tables { UFuncTableUnary UFUNC_NAME; }

#undef BINARY_TABLES
#define BINARY_TABLES(UFUNC_NAME)\
namespace va::ufunc::tables { UFuncTableBinary UFUNC_NAME; UFuncTableBinary UFUNC_NAME##_scalarRight; UFuncTableBinary UFUNC_NAME##_scalarLeft; }

#undef BINARY_TABLES_COMMUTATIVE
#define BINARY_TABLES_COMMUTATIVE(UFUNC_NAME)\
namespace va::ufunc::tables { UFuncTableBinary UFUNC_NAME; UFuncTableBinary UFUNC_NAME##_scalarRight; }
